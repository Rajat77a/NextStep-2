...
export default function ParentDashboard() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-5 md:px-12 py-6 md:py-8">
      ...
      {/* Summary Bar */}
      {latestCard && (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: springEasing, delay: 0.08 }} className="bg-white rounded-2xl shadow-card p-5 md:p-6 mb-6 border-t-[3px] border-coral">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1">
                {latestFlagCounts.green > 0 && <motion.span initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: 'spring', stiffness: 300, damping: 12, delay: 0.15 }} className="px-2 py-0.5 bg-sage/10 text-sage rounded-full font-body text-[10px] font-semibold">{latestFlagCounts.green} green</motion.span>}
                {latestFlagCounts.yellow > 0 && <motion.span initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: 'spring', stiffness: 300, damping: 12, delay: 0.2 }} className="px-2 py-0.5 bg-amber/10 text-amber rounded-full font-body text-[10px] font-semibold">{latestFlagCounts.yellow} yellow</motion.span>}
                {latestFlagCounts.red > 0 && <motion.span initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: 'spring', stiffness: 300, damping: 12, delay: 0.25 }} className="px-2 py-0.5 bg-coral/10 text-coral rounded-full font-body text-[10px] font-semibold">{latestFlagCounts.red} red</motion.span>}
              </div>
            </div>
            <div>
      ...
      <div className="grid lg:grid-cols-[2fr_1fr] gap-6">
        ...
        <div className="space-y-6">
          ...
          {/* Quick Actions */}
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: springEasing, delay: 0.16 }} className="bg-white rounded-2xl shadow-card p-6">
        ...
        <div className="space-y-6">
          ...
          {latestCheck && (
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: springEasing, delay: 0.2 }} className="bg-white rounded-2xl shadow-card p-6 border-t-[3px] border-coral">
          ...
          {/* Progress Mini */}
          {progress && (
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: springEasing, delay: 0.24 }} className="bg-white rounded-2xl shadow-card p-6">
