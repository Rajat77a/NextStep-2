...
import {
  ...
  ChevronLeft, ChevronRight, ChevronUp, Menu, X, Check, Star, Calendar, MessageCircle,
} from 'lucide-react';
...
const faqs = [
  { q: 'Is my child\'s data secure?', a: 'Absolutely. All report cards and analysis are stored with encryption. Your child\'s information is never shared with third parties. Teachers and admins cannot see your Clarity Check or conversation guides â€” only aggregate, anonymized data.' },
...
function AmbientHeroCard() {
  ...
  return (
    ...
    >
      <GlowTiltCard>
        <div className="rounded-2xl overflow-hidden shadow-[0_8px_40px_rgba(0,0,0,0.4)] bg-[#0a0a0f]/70 backdrop-blur-lg border border-white/[0.08] aspect-[4/3] flex items-center justify-center relative">
          ...
          <div className="text-center p-8 relative z-[1]">
            <motion.div
              ...
              className="w-20 h-20 rounded-full bg-white/10 backdrop-blur-sm border border-white/[0.06] flex items-center justify-center mx-auto mb-4"
            >
              <motion.span
      ...
      <motion.div
        ...
        className="absolute -bottom-6 -left-6 md:-left-10 bg-[#0a0a0f]/70 backdrop-blur-lg border border-white/[0.08] rounded-xl shadow-lg p-4 w-[200px]"
      >
        <p className="label-text text-coral mb-2">Clarity Check</p>
        <div className="space-y-1.5">
          <div className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-sage shadow-[0_0_6px_rgba(122,155,138,0.4)]" /><span className="font-body text-xs text-white/80">Math â€” On Track</span></div>
          <div className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-amber shadow-[0_0_6px_rgba(212,160,58,0.4)]" /><span className="font-body text-xs text-white/80">Science â€” Watch</span></div>
          <div className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-coral shadow-[0_0_6px_rgba(232,93,62,0.4)]" /><span className="font-body text-xs text-white/80">English â€” Address</span></div>
        </div>
      </motion.div>
    </motion.div>
  );
...
export default function LandingPage() {
  ...
  // Scroll-linked step card transforms â€” continuous, not triggered
  ...
  // Hero exit transforms â€” content blurs smoothly as it scrolls up
  ...
  // Unique exit transforms per section (maps 0.7â†’1.0 progress to exit values)
  ...
  // Feature demo card parallax â€” subtle Y drift as section scrolls
  ...
  // Scroll-linked step card entrance â€” staggered, continuous
  ...
  return (
    <div className="min-h-screen overflow-x-hidden" style={{ background: '#0a0a0f' }}>
      ...
      {/* Navigation */}
        <nav className="max-w-7xl mx-auto px-5 md:px-12 h-16 md:h-[72px] flex items-center justify-between">
          <Link to="/" onClick={(e) => { e.preventDefault(); navigateWithTransition('/'); }} className="flex items-baseline gap-1 group">
            ...
            <span className="text-coral text-[10px] font-body font-bold">â—</span>
      ...
      {/* Scroll-linked ambient gradient â€” Stripe-inspired living background */}
      <motion.div
        aria-hidden="true"
        className="fixed inset-0 pointer-events-none z-0"
        style={{ background: ambientGradient }}
      />
      {/* Cursor-responsive gradient overlay â€” follows mouse */}
      <div
        aria-hidden="true"
      ...
      >
        {/* Video background â€” crossfade playlist */}
        ...
        {/* Cinematic gradient overlays â€” heavy dark falloff for premium text readability */}
        ...
        {/* Exit wrapper â€” fade + scale + subtle blur as content scrolls up */}
        <motion.div
          ref={heroExitRef}
            ...
            <div className="grid lg:grid-cols-[55%_45%] gap-12 lg:gap-8 items-center">
              <div className="md:bg-[#0a0a0f]/70 md:backdrop-blur-lg md:rounded-2xl md:p-10 md:-ml-10 md:border md:border-white/[0.08] md:shadow-[0_8px_40px_rgba(0,0,0,0.4)]">
                ...
                <motion.p
                  ...
                  style={{ textShadow: '0 2px 12px rgba(0,0,0,0.6)' }}
                >
                  Upload a report card. Get a clear, honest breakdown of what matters â€” plus the exact words to use with your child and their teacher.
                </motion.p>
                <motion.div
      ...
      {/* Parallax depth shapes â€” floating geometric orbs behind content */}
      ...
      <section id="how-it-works" ref={howItWorksRef} className="py-16 md:py-28 relative overflow-hidden" style={{ background: '#0e0e14' }}>
        ...
        >
          ...
          >
            From upload to actionable plan â€” in minutes, not hours.
          </motion.p>
      ...
      <section id="parents" ref={featuresRef} className="py-16 md:py-28 relative overflow-hidden" style={{ background: '#12121a' }}>
        ...
        >
          ...
          {[
            { label: 'CLARITY CHECK', title: "Know what's worth worrying about", desc: "Our AI flags each subject as green, yellow, or red â€” with gentle, advisory language. No predictions about your child's future. Just clear, actionable insights.", bullets: ['Board-specific grade interpretation', 'Soft, non-judgmental language', 'Teacher comment analysis'] },
            ...
            { label: '30-DAY PLAN', title: 'Small habits, real progress', desc: 'A concrete, week-by-week action plan tied directly to what was flagged. Not generic advice â€” targeted steps that address the specific areas from the report card.', bullets: ['Daily and weekly actions', 'Progress tracking', 'Evidence-based suggestions'] },
          ].map((feature, i) => {
      ...
      {/* Stats Counter Bar â€” dramatic count-up strip */}
      ...
      <section ref={portalRef} className="py-16 md:py-28 relative overflow-hidden" style={{ background: '#0e0e14' }}>
        ...
        >
          ...
          <div className="max-w-xl mx-auto grid gap-6 items-stretch">
      ...
      <footer className="bg-charcoal pt-16 md:pt-20 pb-12">
        <div className="max-w-7xl mx-auto px-5 md:px-12">
          ...
          <div className="border-t border-white/[0.08] pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="font-body text-sm text-white/40">Â© 2026 NextStep.AI. All rights reserved.</p>
